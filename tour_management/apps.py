...
class NlpEngineConfig(AppConfig):
    ...
    def ready(self):
        # NOTE: GenericRelation is disabled because ImageMetadata doesn't use
        # Django's GenericForeignKey (content_type/object_id fields).
        # Instead, it uses a simple module/record_id approach.
        # The ImageTrackingMixin handles image relationships without GenericRelation.
        pass
